...
from src.gif_strategies.exchanging_strategies import BubbleSort, CocktailSort
from src.gif_strategies.exchanging_strategies import CombSort, OddEvenSort
from src.gif_strategies.exchanging_strategies import GnomeSort
...
def generate_gif_test_helper(file_name: str, strategy: GifStrategy,
                             values: List[int], image_size: Tuple[int, int]):
